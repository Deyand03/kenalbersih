    ...
    <div class="flex max-w-100vw w-full">
        ...
        <div class="absolute top-0 right-0 w-1/2 h-full flex items-center justify-end py-8 pr-24">
            ...
            <div class="w-full max-w-md">
                ...
                <p class="text-sm text-gray-500 mb-8 text-center px-12">Mari melangkah untuk menjaga dan menciptakan
                    Lingkungan RT yang asri bersama.</p>

                <form method="POST" action="{{ route('register.warga.store') }}">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <x-text-input id="email" class="block mt-1 px-3 py-3 w-full bg-gray-200 rounded-md"
                                type="email" name="email" placeholder="user@gmail.com" :value="old('email')" required
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <select id="rt_id" name="rt_id"
                                    class="block w-full px-3 py-3 bg-gray-200 rounded-md border-gray-200 appearance-none"
                                    required>
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="no_hp" class="block mt-1 px-3 py-3 w-full bg-gray-200 rounded-md"
                            placeholder="Masukkan No. hp" type="tel" name="no_hp" :value="old('no_hp')"
                            required />
                    </div>
