    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-300"
        ...
        <div class="flex-1 p-4 overflow-y-auto bg-slate-50 space-y-3" id="chat-container">
            ...
            <template x-for="msg in messages">
                <div :class="msg.sender === 'user' ? 'flex justify-end' : 'flex justify-start'">
                    <div :class="msg.sender === 'user' ?
                        ...
                        <span x-show="msg.sender === 'bot'" x-html="msg.text" class="prose prose-sm max-w-none"></span>
            ...
            <div x-show="isLoading" class="flex justify-start">
                <div class="bg-slate-200 text-slate-500 rounded-2xl rounded-tl-none py-2 px-4 text-xs animate-pulse">
                    Sedang mengetik...
                </div>
            </div>
        </div>
