@props(['all_rts', 'selectedRtId', 'selectedTahun', 'dataBulanan'])
                ...
                <div class="w-[320px]">
                    ...
                    {{--
                        ...
                        Looping <select> tahun dihapus.
                            ...
                            --}}
                    <input class="select" {{-- <-- Pakai class 'select' agar styling sama --}} type="number" name="tahun"
                        value="{{ $selectedTahun }}" placeholder="Contoh: 2024">
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-10">
            ...
            @if ($dataBulanan->isNotEmpty())
                ...
                @foreach ($dataBulanan as $data_bulan)
                    ...
                    <div
                        class="h-64 lg:h-96 aspect-auto bg-white rounded-lg shadow-lg flex items-center justify-center">
...
@vite('resources/js/utility/chart_homepage.js')
